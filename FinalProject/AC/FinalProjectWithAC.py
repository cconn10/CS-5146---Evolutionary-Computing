...
TARGET_HP = 27
TARGET_TO_HIT = 4
TARGET_STATS = [9, 11, 8, 13, 14, 15]

Z_IDEAL = [17,14]

FILE_STRING = "outputAC.txt"
LAST_POPULATION_FILE = "ac_population.txt"
...
#Creates Genome based on available points.
def InitializeGenome(pointBuy):
    ...
    while points > 0:
        ...
        if coinFlip == 1 and rep[randStat] + 1 <= 18:
            rep[randStat] += 1
            points -= 1
        elif coinFlip == 2 and rep[randStat] - 1 >= 6:
            rep[randStat] -= 1
            points += 1


    #Create genome and set its fitness
    genome = Genome(rep, 0.0, 0, 0)
...
def CreateLambdaPopulation(population, pointBuy):
    ...
    for i in range(10):
        ...
        for i in range(10):
            ...
            offspring = Genome(offspringRep, 0.0, 0, 0)
...
def Mutation(genome):
    ...
    if(random.randint(1,2) == 1):
        ...
        while True:
            ...
            if(genome.representation[fromIndex] - 1 >= 6 and genome.representation[toIndex] + 1 <= 18):
...
def Objective(genome):
    ...
    defCHA = TARGET_STATS[0]
    defWIS = TARGET_STATS[1]
    defINT = TARGET_STATS[2]
    defCON = TARGET_STATS[3]
    defDEX = TARGET_STATS[4]
    defSTR = TARGET_STATS[5]
    ...
    match str(charClass).lower():
        case "artificer":
            ...
            AC = calculate_AC("artificer", "medium", 14, False, calculate_bonus(dexterity), calculate_bonus(constitution), calculate_bonus(wisdom))
        ...
        case "barbarian":
            ...
            AC = calculate_AC("barbarian", "none", 10, False, calculate_bonus(dexterity), calculate_bonus(constitution), calculate_bonus(wisdom))
        ...
        case "bard":
            ...
            AC = calculate_AC("bard","light", 11, True, calculate_bonus(dexterity), calculate_bonus(constitution), calculate_bonus(wisdom))
        ...
        case "cleric":
            ...
            DPR = calculate_dpr_atk_roll(toHit, atkDamage)
            AC = calculate_AC("cleric", "heavy", 17, True, calculate_bonus(dexterity), calculate_bonus(constitution), calculate_bonus(wisdom))
        ...
        case "druid":
            ...
            AC = calculate_AC("druid", "light", 11, True, calculate_bonus(dexterity), calculate_bonus(constitution), calculate_bonus(wisdom))
        ...
        case "fighter":
            ...
            DPR = calculate_dpr_atk_roll(toHit, atkDamage)
            AC = calculate_AC("fighter", "heavy", 16, False, calculate_bonus(dexterity), calculate_bonus(constitution), calculate_bonus(wisdom))
        ...
        case "monk":
            ...
            DPR = calculate_dpr_atk_roll(toHit, atkDamage)
            AC = calculate_AC("monk", "none", 10, False, calculate_bonus(dexterity), calculate_bonus(constitution), calculate_bonus(wisdom))

        case "paladin":
            damageBonus = calculate_bonus(strength)
            # 1d8 for weapon attack
            atkDamage = 4.5 + damageBonus 

            toHit = calculate_bonus(strength) + PROFICIENCY_BONUS

            DPR = calculate_dpr_atk_roll(toHit, atkDamage)
            AC = calculate_AC("paladin", "heavy", 16, True, calculate_bonus(dexterity), calculate_bonus(constitution), calculate_bonus(wisdom))
        ...
        case "ranger":
            ...
            DPR = calculate_dpr_atk_roll(toHit, atkDamage)
            AC = calculate_AC("ranger", "medium", 14, False, calculate_bonus(dexterity), calculate_bonus(constitution), calculate_bonus(wisdom))
        ...
        case "rogue":
            ...
            DPR = calculate_dpr_atk_roll(toHit, atkDamage)
            AC = calculate_AC("rogue", "light", 11, False, calculate_bonus(dexterity), calculate_bonus(constitution), calculate_bonus(wisdom))
        ...
        case "sorcerer":
            ...
            DPR = calculate_dpr_atk_roll(toHit, atkDamage)
            AC = calculate_AC("sorcerer", "none", 10, False, calculate_bonus(dexterity), calculate_bonus(constitution), calculate_bonus(wisdom))
        ...
        case "warlock":
            ...
            AC = calculate_AC("warlock", "light", 11, False, calculate_bonus(dexterity), calculate_bonus(constitution), calculate_bonus(wisdom))
        ...
        case "wizard":
            ...
            DPR = calculate_dpr_atk_roll(toHit, atkDamage)
            AC = calculate_AC("wizard", "none", 13, False, calculate_bonus(dexterity), calculate_bonus(constitution), calculate_bonus(wisdom))

    genome.dpr = DPR
    genome.ac = AC
    return 1 / (math.sqrt(((AC - Z_IDEAL[0]) ** 2) + ((DPR - Z_IDEAL[1]) ** 2)))

def calculate_AC(classType, armorType, armorAC, hasShield, dex, con, wis):
    if classType == "monk":
        return armorAC + dex + wis
    elif classType == "barbarian":
        return armorAC + dex + con
    elif armorType == "light":
        return armorAC + dex
    elif armorType == "medium":
        return armorAC + (dex if dex <=2 else 2)
    elif armorType == "heavy":
        return armorAC
    else:
        return armorAC + dex
...
with open(FILE_STRING, "w") as os:
    with open(LAST_POPULATION_FILE, "w") as lastPop:
        ...
        for genome in population.members:
            lastPop.write("{}, CHA {}, WIS {}, INT {}, CON {}, DEX {}, STR {}\n\tFITNESS {}, AC {}, DPR {}\n".format(
